...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setTotalHeure(string $TotalHeure): self
    {
    ...
    {
        return $this->TotalRestantes;
    }

    public function setTotalRestantes(string $TotalRestantes): self
    {
